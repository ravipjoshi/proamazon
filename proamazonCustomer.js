...
function productAvailability(id,qty)
{
    connection.query("SELECT stock_quantity, product_sales, price  FROM products where ?",{item_id:id}, function(err, res) {
       ...
       {
          console.log("WE HAVE RECEIVED A REQUEST FOR YOUR ORDER. WE ARE EXTREMLY SORRY FOR THE INCONVINIENCE WE CAN NOT FULL FILL YOUR REQUEST BECAUSE OF INSUFFICIENT QUANTITY");
       }
